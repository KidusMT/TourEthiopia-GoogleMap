...
public class OneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MyAdapter adapter = new MyAdapter(new String[]{"Best Restaurant", "Best Car Dealer",
                "Best Coffee House", "Best Shoping Center", "Best Search Capability", "Best Preference"}, new String[]{"Eat", "Car",
                "Coffee", "Shoping", "Searching", "Settings"}, new int[]{
