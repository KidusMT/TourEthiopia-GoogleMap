 ...
 */
public class Hotel_Hilton_Addis extends Fragment {
    ...
    ArrayList<HashMap<String, String>> hilton_location = new ArrayList<HashMap<String, String>>();
    HashMap<String, String> hotel_hilton;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        hotel_hilton = new HashMap<String, String>();
        hotel_hilton.put("Latitude", "9.3428347");
        hotel_hilton.put("Longitude", "9.3428347");
        hotel_hilton.put("LocationName", "Hilton Addis");
        hilton_location.add(hotel_hilton);

        final String lat_hilton = "9.0185003";
        final String lng_hilton = "38.7627713";
        ...
        bshowmapfull.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imap.putExtra("hilton_lat",lat_hilton);
                imap.putExtra("hilton_lng",lng_hilton);
                startActivity(imap);
            }
        });
        contactNo.setText("+251921304594\n+0224550190");
        tvtopic.setText("HILTON ADDIS HOTEL");
