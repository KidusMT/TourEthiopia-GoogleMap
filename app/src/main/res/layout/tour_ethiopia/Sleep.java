...
//        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT)
        ...
        ActionBar.Tab tab = actionBar.newTab()
                .setText("Sleep")
                .setTabListener(new com.googleplaystore.kidusmt.tour_ethiopia.CustomTabListener<>(this, "sleep", com.googleplaystore.kidusmt.tour_ethiopia.Sleep_Fragment.class))
