 ...
 */
public class Hotel_Washington extends android.app.Fragment {
    ...
    ArrayList<HashMap<String, String>> washington_location = new ArrayList<HashMap<String, String>>();
    HashMap<String, String> hotel_washington;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        hotel_washington = new HashMap<String, String>();
        hotel_washington.put("Latitude", "9.3428347");
        hotel_washington.put("Longitude", "9.3428347");
        hotel_washington.put("LocationName", "washington");
        washington_location.add(hotel_washington);
        ...
        bshowmapfull.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imap.putExtra("washington",washington_location);
                startActivity(imap);
            }
        });
        contactNo.setText("+251921304594\n+0224550190");
        tvtopic.setText("WASHINGTON HOTEL");
