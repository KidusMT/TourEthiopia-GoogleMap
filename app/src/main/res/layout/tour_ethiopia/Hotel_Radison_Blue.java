 ...
 */
public class Hotel_Radison_Blue extends android.app.Fragment {
    ...
    ArrayList<HashMap<String, String>> radison_location = new ArrayList<HashMap<String, String>>();
    HashMap<String, String> hotel_radison;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        hotel_radison = new HashMap<String, String>();
        hotel_radison.put("Latitude", "9.3428347");
        hotel_radison.put("Longitude", "9.3428347");
        hotel_radison.put("LocationName", "Radison Hotel");
        radison_location.add(hotel_radison);

        final String lat_radisson = "9.020454";
        final String lng_radisson = "38.759838";
        ...
        bshowmapfull.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imap.putExtra("radisson_lat",lat_radisson);
                imap.putExtra("radisson_lng",lng_radisson);
                startActivity(imap);
            }
        });
        contactNo.setText("+251921304594\n+0224550190");
        tvtopic.setText("RADISON HOTEL");
        imageView.setImageResource(R.drawable.logo_radisson);
