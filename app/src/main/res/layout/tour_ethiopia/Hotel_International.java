 ...
 */
public class Hotel_International extends Fragment {
    ...
    ArrayList<HashMap<String, String>> intercontinental_location = new ArrayList<HashMap<String, String>>();
    HashMap<String, String> hotel_intercontinental;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        hotel_intercontinental = new HashMap<String, String>();
        hotel_intercontinental.put("Latitude", "9.3428347");
        hotel_intercontinental.put("Longitude", "9.3428347");
        hotel_intercontinental.put("LocationName", "Intercontinental");
        intercontinental_location.add(hotel_intercontinental);
        ...
        bshowmapfull.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imap.putExtra("intercontinental",intercontinental_location);
                startActivity(imap);
            }
        });
        contactNo.setText("+251921304594\n+0224550190");
        tvtopic.setText("INTERCONTINENTAL HOTEL");
